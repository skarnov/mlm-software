<script>
    function calculating()
    {
        ...
        var transaction_fee = ((3.5 * 1) / (100)) * (withdrawalAmount * 1);
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Bank Balance Withdrawal</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form action="<?php echo base_url(); ?>agent/save_bank_balance_withdrawal" method="POST">
                        <h3 style="color:red">
                            <?php
                            $msg = $this->session->userdata('save_agent_balance_withdrawal');
                            if (isset($msg)) {
                                echo "<p style='margin-left:2%;'>$msg</p>";
                                $this->session->unset_userdata('save_agent_balance_withdrawal');
                            }
                            ?>
                        </h3>
                        <div class="col-xs-6 col-xs-offset-3">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bank_name" required placeholder="Enter Bank Name" class="form-control">
                                </div>                     
                                <div class="form-group">
                                    <label>Account Number <span style="color: red">(Required)</span></label>
                                    <input type="text" name="account_number" required placeholder="Enter Bank Name" class="form-control">
                                </div>                     
                                <div class="form-group">
                                    <label>Branch Name</label>
                                    <input type="text" name="branch_name" required placeholder="Enter Branch Name" class="form-control">
                                </div>                     
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="3.5" class="form-control">
                                </div>
                                <div class="form-group">
